...
#I also calculated the mean, median, variance and standard deviation of the mon column
mean(sports$mon)
median(sports$mon)
var(sports$mon)
sd(sports$mon)

#Finally i calculated mean, median, variance and standard deviation of the tot_attend column
